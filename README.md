...
Everything you need to go from zero ML knowledge to understanding, building, and training large language models.
...
| CMU Advanced NLP | [Homepage](https://cmu-l3.github.io/anlp-spring2026/) [Recording](https://youtube.com/playlist?list=PLqC25OT8ZpD15emhQhNjRLym77-sp2kAx) | MOOC | A complement to CS336. |

## LLM Domain Adaptation / Post-training

Resources on adapting pre-trained LLMs to specific domains and tasks.

| Name | Link | Type | Value |
| --- | --- | --- | --- |
| A Comparative Analysis of LLM Adaptation: SFT, LoRA, and ICL in Data-Scarce Scenarios | [Link](https://arxiv.org/abs/2511.00130) | Survey | Empirically compares SFT, LoRA, and ICL when data is scarce — practical guidance for picking an adaptation strategy. |
| LoRA Without Regret | [Link](https://thinkingmachines.ai/blog/lora/) | Blog | Industrial LoRA Best Practice. |
| Reinforcement Learning for LLM Post-Training: A Survey | [Link](https://arxiv.org/abs/2407.16216) | Survey | Comprehensive introduction of RL methods for LLM post-training. |
| NAACL 2025 Tutorial: Adaptation of Large Language Models | [Link](https://vincent950129.github.io/adapt-llm/naacl25_tutorial.html) | Tutorial | An overview of dynamic, domain-specific, and task-adaptive LLM adaptation techniques. |

## Agentic AI Build

Resources for understanding, designing, and building agentic AI systems.

| Name | Link | Type | Value |
| --- | --- | --- | --- |
| The Hitchhiker's Guide to Agentic AI: From Foundations to Systems | [Link](https://arxiv.org/abs/2606.24937) | Survey | End-to-end survey from agentic AI foundations to system design. |
