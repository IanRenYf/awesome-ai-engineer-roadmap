...
| Reinforcement Learning for LLM Post-Training: A Survey | [Link](https://arxiv.org/abs/2407.16216) | Paper-Survey | Comprehensive survey of RL methods for LLM post-training (RLHF and beyond). |
...
| Name | Link | Type | Value |
| --- | --- | --- | --- |
| A Comparative Analysis of LLM Adaptation: SFT, LoRA, and ICL in Data-Scarce Scenarios | [Link](https://arxiv.org/abs/2511.00130) | Paper | Empirically compares SFT, LoRA, and ICL when data is scarce — practical guidance for picking an adaptation strategy. |
| LoRA Without Regret | [Link](https://thinkingmachines.ai/blog/lora/) | Blog | When LoRA works, when it doesn't, and how to avoid common pitfalls. |
| NAACL 2025 Tutorial: Adaptation of Large Language Models | [Link](https://vincent950129.github.io/adapt-llm/naacl25_tutorial.html) | Tutorial | A tutorial covering the full landscape of LLM adaptation techniques. |
...
| Name | Link | Type | Value |
| --- | --- | --- | --- |
| The Hitchhiker's Guide to Agentic AI: From Foundations to Systems | [Link](https://arxiv.org/abs/2606.24937) | Paper-Survey | End-to-end survey from agentic AI foundations to system design. |
